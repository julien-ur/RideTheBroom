...
class BoardEvent:
	def __init__(self, topLeft,topRight,bottomLeft,bottomRight, buttonPressed, buttonReleased):
		...
		self.top = (topLeft + topRight) / 2
		self.bottom = (bottomLeft + bottomRight) / 2
		self.left = (topLeft + bottomLeft) / 2
		self.right = (topRight + bottomRight) / 2
		self.buttonPressed = buttonPressed
		self.buttonReleased = buttonReleased
		#convenience value
		self.totalWeight = topLeft + topRight + bottomLeft + bottomRight
		self.values = [topLeft, topRight, bottomLeft, bottomRight]
		self.valuesSides = [self.top, self.bottom, self.left, self.right]
